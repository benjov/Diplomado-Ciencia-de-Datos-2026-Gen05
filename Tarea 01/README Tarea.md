...
Esta actividad es en equipos de 3 o 4 personas. Los equipos elegirán un dataset y una técnica (Regresión o Clustering).
...
## 👥 Modalidad y entrega
	•	Equipos de 3–4 personas (recomendado).
